...
# Step 2
- (x) Move Cheetah-only directives and documentation into the upstream `cheetah-db/` submodule; read `cheetah-db/AGENTS.md` when working with Cheetah and commit generic server fixes directly in `cekkr/cheetah`.
