...
- Remove the reference to "Emotional Embeddings" et simili: this is a reference of the current dataset, so you have to transform it in a generic "additional context token"