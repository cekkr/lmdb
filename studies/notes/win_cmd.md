python3.11 src/train.py datasets/emotion_data.json --ngram-order 3 --recursive --reset --json-chunk-size 50 --eval-samples 2 --eval-pool-size 5000 --chunk-eval-percent 10.0 --eval-interval 5000 --profile-ingest --decoder-presence-penalty 0.75 --decoder-frequency-penalty 0.5 --context-dimensions 4,6,8
