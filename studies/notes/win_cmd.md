...
Very complex -1:
python3.13 src/train.py datasets/GPTeacher.json --ngram-order 4 --merge-max-tokens 3 --json-chunk-size 100 --eval-samples 2 --eval-variants 2 --chunk-eval-percent 20.0 --eval-interval 50000 --decoder-presence-penalty 0.2 --decoder-frequency-penalty 0.1 --context-dimensions 24,32,64 --reset --profile-ingest
