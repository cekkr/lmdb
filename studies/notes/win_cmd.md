...
Very complex -1:
python3.13 src/train.py datasets/GPTeacher.json --ngram-order 5 --merge-max-tokens 4 --json-chunk-size 200 --eval-samples 2 --eval-variants 2 --chunk-eval-percent 15.0 --eval-interval 50000 --decoder-presence-penalty 0.25 --decoder-frequency-penalty 0.1 --context-dimensions 16,24,32,64 --reset --profile-ingest
