...
ADVANCED MERGE:
python3.12 src/train.py datasets/GPTeacher.json --ngram-order 6 --merge-max-tokens 2 --json-chunk-size 500 --eval-samples 2 --eval-variants 2 --chunk-eval-percent 10.0 --eval-interval 10000 --decoder-presence-penalty 0.2 --decoder-frequency-penalty 0.1 --context-dimensions 16,32,64,128 --context-window-depth 128 --cheetah-adversarial-threshold 0.5 --merge-recursion-depth 3 --merge-significance-threshold 0.1 --eval-pool-size 50 --context-window-train-windows 16 --context-window-infer-windows 16 --context-window-stride-ratio 0.5 --reset

Self-content merge:
python3.12 src/train.py datasets/GPTeacher.json --ngram-order 5 --merge-max-tokens 2 --json-chunk-size 50 --eval-samples 2 --eval-variants 2 --chunk-eval-percent 10.0 --eval-interval 10000 --decoder-presence-penalty 0.4 --decoder-frequency-penalty 0.2 --context-dimensions 8,16,32,64 --cheetah-adversarial-threshold 0.1 --merge-recursion-depth 4 --merge-significance-threshold 0.75 --context-window-infer-windows 0 --context-window-stride-ratio 0 --context-window-depth 128 --context-window-stride-ratio 0.75 --reset

Self-content AUTOTUNING merge:
python3.12 src/train.py datasets/GPTeacher.json --ngram-order 0 --merge-max-tokens 2 --json-chunk-size 250 --eval-samples 2 --eval-variants 2 --chunk-eval-percent 10.0 --eval-interval 100000 --context-dimensions 4,8,16,32,64,128 --context-window-depth 128 --cheetah-adversarial-threshold 0.5 --merge-recursion-depth 4 --merge-significance-threshold 0.5 --eval-pool-size 50 --context-window-train-windows 0 --context-window-infer-windows 0 --context-window-stride-ratio 0 --reset
...
Very complex -1:
python3.13 src/train.py datasets/GPTeacher.json --ngram-order 5 --merge-max-tokens 3 --json-chunk-size 1000 --eval-samples 2 --eval-variants 2 --chunk-eval-percent 5.0 --eval-interval 50000 --decoder-presence-penalty 0.4 --decoder-frequency-penalty 0.15 --context-dimensions 16,24,32,64 --merge-recursion-depth 2 --merge-significance-threshold 0.15 --reset --profile-ingest
...
`wsl.exe -d Ubuntu-24.04 -- screen -dmS cheetahdb bash -c 'cd /mnt/c/Sources/GitHub/lmdb/cheetah-db && env CHEETAH_HEADLESS=1 ./cheetah-server'`.
