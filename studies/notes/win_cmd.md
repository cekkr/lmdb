...
Very complex -1:
python3.13 src/train.py datasets/GPTeacher.json --ngram-order 5 --merge-max-tokens 3 --json-chunk-size 1000 --eval-samples 2 --eval-variants 2 --chunk-eval-percent 5.0 --eval-interval 50000 --decoder-presence-penalty 0.4 --decoder-frequency-penalty 0.15 --context-dimensions 16,24,32,64 --reset --profile-ingest
