...
Very complex:
python3.13 src/train.py datasets/GPTeacher.json --ngram-order 8 --json-chunk-size 500 --eval-samples 3 --eval-variants 3 --chunk-eval-percent 10.0 --eval-interval 50000 --profile-ingest --decoder-presence-penalty 0.2 --decoder-frequency-penalty 0.05 --context-dimensions 16,24,32,48,64 --reset
