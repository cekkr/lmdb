...
Self-content merge:
python3.12 src/train.py datasets/GPTeacher.json --ngram-order 5 --merge-max-tokens 2 --json-chunk-size 50 --eval-samples 2 --eval-variants 2 --chunk-eval-percent 10.0 --eval-interval 10000 --decoder-presence-penalty 0.2 --decoder-frequency-penalty 0.05 --context-dimensions 8,16,32,64,128 --context-window-depth 64 --cheetah-adversarial-threshold 0.5 --merge-recursion-depth 4 --merge-significance-threshold 0.1 --context-window-infer-windows 0 --context-window-stride-ratio 0 --context-window-depth 128 --context-window-stride-ratio 0.75 --reset
