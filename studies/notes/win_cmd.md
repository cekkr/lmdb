...
Very complex -1:
python3.13 src/train.py datasets/GPTeacher.json --ngram-order 5 --merge-max-tokens 5 --json-chunk-size 100 --eval-samples 2 --eval-variants 2 --chunk-eval-percent 15.0 --eval-interval 50000 --profile-ingest --decoder-presence-penalty 0.3 --decoder-frequency-penalty 0.15 --context-dimensions 16,24,32,48 --reset
