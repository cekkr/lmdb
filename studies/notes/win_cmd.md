...
Windows:
python3.11 src/train.py datasets/GPTeacher.json --ngram-order 3 --reset --json-chunk-size 100 --eval-samples 2 --eval-variants 2 --chunk-eval-percent 10.0 --eval-interval 40000 --profile-ingest --decoder-presence-penalty 0.5 --decoder-frequency-penalty 0.25 --context-dimensions 4,8,12,16
