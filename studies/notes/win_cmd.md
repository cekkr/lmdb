...
Windows:
python3.11 src/train.py datasets/GPTeacher.json --ngram-order 3 --reset --json-chunk-size 100 --eval-samples 3 --eval-variants 4 --chunk-eval-percent 20.0 --eval-interval 5000 --profile-ingest --decoder-presence-penalty 0.5 --decoder-frequency-penalty 0.25 --context-dimensions 8,12,16,24
