...
Windows:
python3.11 src/train.py datasets/GPTeacher.json --ngram-order 4 --reset --json-chunk-size 200 --eval-samples 3 --eval-variants 2 --chunk-eval-percent 10.0 --eval-interval 100000 --profile-ingest --decoder-presence-penalty 0.5 --decoder-frequency-penalty 0.25 --context-dimensions 6,12,18,24
