...
Linux Mint:
python3.13 src/train.py datasets/GPTeacher.json --ngram-order 6 --json-chunk-size 500 --eval-samples 2 --eval-variants 2 --chunk-eval-percent 20.0 --eval-interval 50000 --profile-ingest --decoder-presence-penalty 0.3 --decoder-frequency-penalty 0.1 --context-dimensions 8,12,16,22,32 --reset
